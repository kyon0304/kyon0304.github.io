---
title: "Philosophy of Software Design 第二章 复杂度的天性"
date: 2020-02-19T12:15:39+08:00
lastMod: 2020-02-19T19:16:39+08:00
tags: ["鹦鹉学舌", "学习笔记"]
...
{{< figure src="/media/software-design/figure-2-1.png" alt="figure 2.1" caption="__图2.1：__ 网站的每个页面都会展示有颜色的横幅。(a) 中横幅的背景色是在每个页面中显示指定的。(b) 中共享变量保存背景色的值，每个页面都指向这个变量。(c) 中一些页面会展示额外的颜色表示强调，这个颜色是背景色带阴影的较暗的转换；如果背景色变化了，强调色也必须跟着变化。" class="left" >}}
...
[^1]: 我已当场去世，sophisticated 和 complex 完全不知道怎么区分。。