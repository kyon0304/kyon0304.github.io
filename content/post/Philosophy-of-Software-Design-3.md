...
{{< figure src="/media/software-design/figure-3-1.png" alt="图 3.1" caption="__图 3.1__：开始，战术式编程会比战略式编程进度更快。然而，战术方式下复杂性会更快地积累。随着时间流逝，战略方式进度会更快。注意：这张图只是定性的说明；我不知道任何可以对这个曲线进行精确测量的经验" >}}
